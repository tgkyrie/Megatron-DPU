...
DATA_ARG=${4:-"MOCK"}
DATA_CACHE_PATH="${PWD}/benchmark_cache_qwen_3b_tp_megascale_ps"
...
echo "[tp-megascale_ps] NODE_RANK='"$NODE_RANK"' RANK=${RANK:-unset} LOCAL_RANK=$LOCAL_RANK CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES"
echo "[tp-megascale_ps] MASTER_ADDR='"$MASTER_ADDR"' MASTER_PORT='"$MASTER_PORT"'"
echo "[tp-megascale_ps] DMLC_NODE_HOST=$DMLC_NODE_HOST DMLC_PS_ROOT_URI=$DMLC_PS_ROOT_URI DMLC_PS_ROOT_PORT=$DMLC_PS_ROOT_PORT"
echo "[tp-megascale_ps] DMLC_NUM_WORKER=$DMLC_NUM_WORKER MEGASCALE_PS_LOCAL_SIZE=$MEGASCALE_PS_LOCAL_SIZE MEGASCALE_PS_LOCAL_RANK=$MEGASCALE_PS_LOCAL_RANK DMLC_WORKER_ID=$DMLC_WORKER_ID"
