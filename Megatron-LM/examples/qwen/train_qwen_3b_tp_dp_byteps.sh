...
# Enable the BytePS DP and TP paths by default. Set USE_DPU_DP=0
...
export BYTEPS_SERVER_ENABLE_SCHEDULE=${BYTEPS_SERVER_ENABLE_SCHEDULE:-0}
...
if [[ "${DMLC_ENABLE_UCX}" == "1" ]]; then
    ...
    export BYTEPS_ADDRESS_POOL_SIZE=${BYTEPS_ADDRESS_POOL_SIZE:-10240}
...
echo "[byteps-net] DMLC_ENABLE_UCX=${DMLC_ENABLE_UCX} DMLC_ENABLE_RDMA=${DMLC_ENABLE_RDMA} DMLC_USE_GDR=${DMLC_USE_GDR} BYTEPS_ENABLE_FUSED_PUSH_PULL=${BYTEPS_ENABLE_FUSED_PUSH_PULL} BYTEPS_PARTITION_BYTES=${BYTEPS_PARTITION_BYTES} BYTEPS_ADDRESS_POOL_SIZE=${BYTEPS_ADDRESS_POOL_SIZE} BYTEPS_RDMA_RX_DEPTH=${BYTEPS_RDMA_RX_DEPTH} BYTEPS_RDMA_START_DEPTH=${BYTEPS_RDMA_START_DEPTH} BYTEPS_SERVER_ENABLE_SCHEDULE=${BYTEPS_SERVER_ENABLE_SCHEDULE:-unset}"
