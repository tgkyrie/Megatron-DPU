...
const DataType TorchTensor::dtype() const {
  switch (tensor_.scalar_type()) {
    case ::torch::kByte:
      return DataType::MEGASCALE_PS_UINT8;
    case ::torch::kChar:
      return DataType::MEGASCALE_PS_INT8;
    // case ::torch::kShort:
    //   return DataType::MEGASCALE_PS_INT16;
    case ::torch::kInt:
      return DataType::MEGASCALE_PS_INT32;
    case ::torch::kLong:
      return DataType::MEGASCALE_PS_INT64;
    case ::torch::kHalf:
      return DataType::MEGASCALE_PS_FLOAT16;
    case ::torch::kFloat:
      return DataType::MEGASCALE_PS_FLOAT32;
    case ::torch::kDouble:
      return DataType::MEGASCALE_PS_FLOAT64;
    default:
