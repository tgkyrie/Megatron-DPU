...
from megascale_ps.torch.ops import push_pull_group_sync_inplace as megascale_ps_push_pull_group
from megascale_ps.torch.ops import push_pull_async_inplace as megascale_ps_push_pull
from megascale_ps.torch.ops import poll, synchronize, declare, megascale_ps_torch_set_num_grads
from megascale_ps.torch.ops import size, local_size, rank, local_rank
from contextlib import contextmanager
import megascale_ps as bps
...
class DistributedDataParallel(Module):
    ...
    def __init__(self, module, device_ids=None,
        ...
        if size() > 1:
            ...
            megascale_ps_torch_set_num_grads(self._num_grads)
    ...
    def no_sync(self):
        ...
        Example::
            ...
            >>> ddp = megascale_ps.torch.parallel.DistributedDataParallel(model, pg)
            >>> with ddp.no_sync():
            ...   for input in inputs:
    ...
    def _push_pull_grad_group_sync(self, p, num_grads_):
        ...
        if self._enable_async:
            ...
            handle, grad_count = megascale_ps_push_pull_group(tensor_compressed, average=True,
                    name="Gradient."+name)
