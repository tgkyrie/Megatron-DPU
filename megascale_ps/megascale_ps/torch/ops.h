...
#ifndef MEGASCALE_PS_TORCH_OPS_H
#define MEGASCALE_PS_TORCH_OPS_H
...
#define PUSHPULL_H(torch_Tensor, THTensor)                         \
  extern "C" int megascale_ps_torch_push_pull_async_##torch_Tensor(      \
...
extern "C" int megascale_ps_torch_poll(int handle);
extern "C" void megascale_ps_torch_wait_and_clear(int handle);
extern "C" void megascale_ps_torch_declare_tensor(char* name);
extern "C" void megascale_ps_torch_register_tensor_group(char* name, int expected_workers);

}  // namespace torch
}  // namespace megascale_ps

#endif  // MEGASCALE_PS_TORCH_OPS_H
