...
from megascale_ps.tensorflow import init
from megascale_ps.tensorflow import shutdown
from megascale_ps.tensorflow import size
from megascale_ps.tensorflow import local_size
from megascale_ps.tensorflow import rank
from megascale_ps.tensorflow import local_rank
from megascale_ps.tensorflow import Compression

import megascale_ps._keras as _impl
from megascale_ps.tensorflow.keras import callbacks
...
def load_model(filepath, custom_optimizers=None, custom_objects=None, compression=Compression.none):
    """
    Loads a saved Keras model with a MegaScalePS DistributedOptimizer.
