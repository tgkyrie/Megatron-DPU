...
const common::DataType ConvertDType(int dtype) {
  switch (dtype) {
    case ::tensorflow::DT_UINT8:
      return common::MEGASCALE_PS_UINT8;
    case ::tensorflow::DT_INT8:
      return common::MEGASCALE_PS_INT8;
    // case ::tensorflow::DT_UINT16:
    //   return common::MEGASCALE_PS_UINT16;
    // case ::tensorflow::DT_INT16:
    //   return common::MEGASCALE_PS_INT16;
    case ::tensorflow::DT_INT32:
      return common::MEGASCALE_PS_INT32;
    case ::tensorflow::DT_INT64:
      return common::MEGASCALE_PS_INT64;
    case ::tensorflow::DT_HALF:
      return common::MEGASCALE_PS_FLOAT16;
    case ::tensorflow::DT_FLOAT:
      return common::MEGASCALE_PS_FLOAT32;
    case ::tensorflow::DT_DOUBLE:
      return common::MEGASCALE_PS_FLOAT64;
    // case ::tensorflow::DT_BOOL:
    //   return common::MEGASCALE_PS_BOOL;
    default:
...
extern "C" void megascale_ps_tensorflow_declare_tensor(char* name) {
...
void StartTask(::tensorflow::OpKernelContext* context,
               ...
               std::string node_name, std::shared_ptr<TFTensor> megascale_ps_input,
               std::shared_ptr<TFTensor> megascale_ps_output,
               std::shared_ptr<common::ReadyEvent> ready_event) {
  auto& megascale_ps_context = common::GetContextFromName(node_name);
  auto device = GetDeviceID(context);
  auto size = megascale_ps_input->size();
  auto dtype = megascale_ps_input->dtype();
  void* cpubuff = (device == CPU_DEVICE_ID)
                      ? const_cast<void*>(megascale_ps_input->data())
                      : nullptr;
  common::InitTensor(megascale_ps_context, size, dtype, cpubuff);
  ...
  auto enqueue_result =
      EnqueueTensor(megascale_ps_context, megascale_ps_input, megascale_ps_output, ready_event,
                    device, -megascale_ps_context.declared_key, 0,
...
class MegaScalePSPushPullOp : public ::tensorflow::AsyncOpKernel {
  private:
     std::string input_tensor_name;
 public:
  explicit MegaScalePSPushPullOp(::tensorflow::OpKernelConstruction* context)
...
REGISTER_KERNEL_BUILDER(Name("MegaScalePSPushPull").Device(::tensorflow::DEVICE_CPU),
                        MegaScalePSPushPullOp);
REGISTER_KERNEL_BUILDER(Name("MegaScalePSPushPull").Device(::tensorflow::DEVICE_GPU),
                        MegaScalePSPushPullOp);

REGISTER_OP("MegaScalePSPushPull")
