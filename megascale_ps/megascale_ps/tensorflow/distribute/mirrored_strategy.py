...
from megascale_ps.tensorflow.distribute import cross_device_ops as cross_device_ops_lib
...
class MyMirroredExtended(distribute_lib.StrategyExtendedV1):
  ...
  def __init__(self, container_strategy, devices=None, cross_device_ops=None):
    ...
    # x2682
    self._cross_device_ops = cross_device_ops_lib.MegaScalePSCrossDeviceOps()
  ...
  def _initialize_single_worker(self, devices):
    ...
    # self._inferred_cross_device_ops = None if self._cross_device_ops else (
    #     cross_device_ops_lib.MegaScalePSCrossDeviceOps())
    #     cross_device_ops_lib.MegaScalePSAllReduce())
