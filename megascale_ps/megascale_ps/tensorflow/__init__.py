...
from megascale_ps.tensorflow.compression import Compression
from megascale_ps.tensorflow.ops import broadcast, _push_pull
from megascale_ps.tensorflow.ops import init, shutdown, suspend, resume, get_pushpull_speed
from megascale_ps.tensorflow.ops import size, local_size, rank, local_rank
from megascale_ps.tensorflow.ops import handle_average_backwards_compatibility
...
def push_pull(tensor, scope='', average=None, device_dense='', device_sparse='',
    ...
    with tf.device(device_dense):
        megascale_ps_size = tf.cast(size(), dtype=tensor.dtype)
        ...
        if not enable_async:
            ...
            new_tensor = (_div(summed_tensor, megascale_ps_size)
...
def DistributedOptimizer(optimizer, name=None, use_locking=False, device_dense='',
    ...
    across all the MegaScalePS ranks.
    ...
    if isinstance(optimizer, _LegacyOptimizer):
        ...
        import megascale_ps.tensorflow.keras as bps_k
