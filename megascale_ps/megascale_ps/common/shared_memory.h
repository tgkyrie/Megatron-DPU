...
#ifndef MEGASCALE_PS_SHARED_MEMORY_H
#define MEGASCALE_PS_SHARED_MEMORY_H
...
class MegaScalePSSharedMemory {
 public:
  MegaScalePSSharedMemory() {}
  ...
  ~MegaScalePSSharedMemory() {
    ...
    BPS_LOG(DEBUG) << "Clear shared memory: all MegaScalePS shared memory "
...
#endif  // MEGASCALE_PS_SHARED_MEMORY_H
