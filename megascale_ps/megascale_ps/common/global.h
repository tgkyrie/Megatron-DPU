...
#ifndef MEGASCALE_PS_GLOBAL_H
#define MEGASCALE_PS_GLOBAL_H
...
class MegaScalePSGlobal {
 public:
  ...
  static MegaScalePSRole GetMyRole() { return _my_role; }
  static std::shared_ptr<MegaScalePSComm> GetBasicComm() { return _basic_comm; }
  static std::shared_ptr<MegaScalePSSharedMemory> GetSharedMemoryObj() {
    return _shm_obj;
  }

  static MegaScalePSScheduledQueue* GetScheduledQueue(QueueType queueType);
 ...
 private:
  ...
  static MegaScalePSRole _my_role;
  static std::shared_ptr<MegaScalePSComm> _basic_comm;
  static std::shared_ptr<MegaScalePSSharedMemory> _shm_obj;
  static int _push_thread;

  static volatile MegaScalePSScheduledQueue* _queues[QueueNum];
