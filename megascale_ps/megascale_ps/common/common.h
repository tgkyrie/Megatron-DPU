...
#ifndef MEGASCALE_PS_COMMON_H
#define MEGASCALE_PS_COMMON_H
...
enum DataType {
  MEGASCALE_PS_FLOAT32 = 0,
  MEGASCALE_PS_FLOAT64 = 1,
  MEGASCALE_PS_FLOAT16 = 2,
  MEGASCALE_PS_UINT8 = 3,
  MEGASCALE_PS_INT32 = 4,
  MEGASCALE_PS_INT8 = 5,
  MEGASCALE_PS_INT64 = 6,
  // below are not in mshadow, should avoid using these
  // MEGASCALE_PS_UINT16 = 7,
  // MEGASCALE_PS_INT16 = 8,
  // MEGASCALE_PS_BOOL = 9,
  // MEGASCALE_PS_BYTE = 10,
};
...
typedef struct MegaScalePSContext {
  bool initialized;
