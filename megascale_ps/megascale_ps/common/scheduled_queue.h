...
#ifndef MEGASCALE_PS_SCHEDULED_QUEUE_H
#define MEGASCALE_PS_SCHEDULED_QUEUE_H
...
class MegaScalePSScheduledQueue {
 public:
  MegaScalePSScheduledQueue(QueueType type);
...
#endif  // MEGASCALE_PS_SCHEDULED_QUEUE_H
