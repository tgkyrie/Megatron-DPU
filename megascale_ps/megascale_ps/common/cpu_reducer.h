...
#ifndef MEGASCALE_PS_CPU_REDUCER_H
#define MEGASCALE_PS_CPU_REDUCER_H
...
class CpuReducer {
 public:
  CpuReducer(std::shared_ptr<MegaScalePSComm> comm);
  ~CpuReducer() {
...
#ifndef MEGASCALE_PS_BUILDING_SERVER
  bool isRoot();
  std::shared_ptr<MegaScalePSComm> getComm() { return _comm; }
#endif
 ...
 private:
  ...
  std::shared_ptr<MegaScalePSComm> _comm;
  int _num_threads;
...
#endif  // MEGASCALE_PS_CPU_REDUCER_H
