...
#ifndef MEGASCALE_PS_COMPRESSOR_COMPRESSOR_REGISTRY_H
#define MEGASCALE_PS_COMPRESSOR_COMPRESSOR_REGISTRY_H
...
#endif  // MEGASCALE_PS_COMPRESSOR_COMPRESSOR_REGISTRY_H