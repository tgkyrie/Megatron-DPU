...
#ifndef MEGASCALE_PS_COMPRESSOR_IMPL_VANILLA_ERROR_FEEDBACK_H
#define MEGASCALE_PS_COMPRESSOR_IMPL_VANILLA_ERROR_FEEDBACK_H
...
#endif  // MEGASCALE_PS_COMPRESSOR_IMPL_VANILLA_ERROR_FEEDBACK_H