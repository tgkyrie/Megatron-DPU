...
#ifndef MEGASCALE_PS_COMPRESSOR_IMPL_NESTEROV_MOMENTUM_H
#define MEGASCALE_PS_COMPRESSOR_IMPL_NESTEROV_MOMENTUM_H
...
#endif  // MEGASCALE_PS_COMPRESSOR_IMPL_NESTEROV_MOMENTUM_H