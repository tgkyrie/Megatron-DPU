...
We suggest you read the Horovod troubleshooting, especially for problems during the build process. MegaScalePS has almost the same dependencies as Horovod minus MPI.
...
```
git clone -b megascale_ps https://github.com/bytedance/ps-lite.git
cd ps-lite
make -j
```
