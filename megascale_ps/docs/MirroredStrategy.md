...
The MegaScalePS MirroredStrategy module is compatible with tensorflow
MultiWorkerMirroredStrategy for the most part. Instead of using the builtin
tensorflow collective communication implementation, it uses MegaScalePS push-pull
...
from  megascale_ps.tensorflow.distribute import MirroredStrategy
