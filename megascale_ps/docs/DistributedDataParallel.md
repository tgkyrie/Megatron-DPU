...
MegaScalePS Distributed Data Parallel module is compatible with PyTorch Distributed
Data Parallel for the most part. Instead of using PyTorch communication
backends, it uses MegaScalePS push-pull for gradients reduction between nodes.
...
```python
# megascale_ps_ddp_example.py
from megascale_ps.torch.parallel import DistributedDataParallel
