...
// should have the same prefix with MegaScalePS shared memory
static const std::string kShmPrefix("MegaScalePS_ShM_");
static const std::string kShmPciePrefix("MegaScalePS_Pcie");
