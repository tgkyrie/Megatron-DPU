...
python dist_launcher.py --worker-hostfile worker_hosts --server-hostfile server_hosts \
        ...
        'echo this is $DMLC_ROLE; python megascale_ps/launcher/launch.py YOUR_COMMAND'
```

The script will automatically help you setup the necessary [environment variables](/docs/env.md) and launch MegaScalePS processes.