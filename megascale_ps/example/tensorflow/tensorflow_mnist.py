...
import os
import errno
import megascale_ps.tensorflow as bps
import numpy as np
...
def main(_):
    ...
    hooks = [
        # MegaScalePS: BroadcastGlobalVariablesHook broadcasts initial variable states
        # from rank 0 to all other processes. This is necessary to ensure consistent
        # initialization of all workers when training is started with random weights
        # or restored from a checkpoint.
        bps.BroadcastGlobalVariablesHook(0),

        # MegaScalePS: adjust number of steps based on number of GPUs.
    ...
    # MegaScalePS: save checkpoints only on worker 0 to prevent other workers from
    # corrupting them.
