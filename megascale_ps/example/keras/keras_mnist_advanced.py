...
# MegaScalePS: initialize MegaScalePS.
bps.init()
...
# MegaScalePS: save checkpoints only on worker 0 to prevent other workers from corrupting them.
if bps.rank() == 0:
...
# Train the model.
# MegaScalePS: the training will randomly sample 1 / N batches of training data and
