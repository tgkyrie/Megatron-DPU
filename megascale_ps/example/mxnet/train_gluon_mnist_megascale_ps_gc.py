...
# MegaScalePS: pin context to local rank
...
# MegaScalePS: create DistributedTrainer, a subclass of gluon.Trainer
...
total_time = 0
# Train model
bps.megascale_ps_declare_tensor("acc")
for epoch in range(args.epochs):
    ...
    bps.megascale_ps_push_pull(acc, name="acc", is_average=False)
    acc /= bps.size()
