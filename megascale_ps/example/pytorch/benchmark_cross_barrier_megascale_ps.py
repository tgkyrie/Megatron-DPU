...
import numpy as np
import os
import megascale_ps.torch.cross_barrier as bps

"""
This example shows how to enable barrier crossing on top of MegaScalePS in PyTorch. Note that you can use MegaScalePS without
...
layer is updated. Hence it can further improves training performance beyond MegaScalePS. See the paper
...
To see performance gain, the system parameters should be properly set, including MEGASCALE_PS_PARTITION_BYTES and
MEGASCALE_PS_SCHEDULING_CREDIT.
"""
