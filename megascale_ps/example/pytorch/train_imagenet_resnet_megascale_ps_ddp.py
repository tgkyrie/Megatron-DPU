...
# example usage:
#
#  bpslaunch python train_imagenet_resnet_megascale_ps_ddp.py -a resnet18 --dist-url 'tcp://127.0.0.1:12345' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 /path/to/imagenet/training/data/
#
