...
class MetaTest(type):
    BASE_ENV = {"DMLC_NUM_WORKER": "1",
                ...
                "MEGASCALE_PS_LOG_LEVEL": "INFO",
                "MEGASCALE_PS_MIN_COMPRESS_BYTES": "0",
                "MEGASCALE_PS_PARTITION_BYTES": "2147483647"}
    ...
    def __new__(cls, name, bases, dict):
        ...
        os.environ["MEGASCALE_PS_THREADPOOL_SIZE"] = "4"
        os.environ["MEGASCALE_PS_FORCE_DISTRIBUTED"] = "1"
        os.environ["MEGASCALE_PS_LOCAL_RANK"] = "0"
        os.environ["MEGASCALE_PS_LOCAL_SIZE"] = "1"
