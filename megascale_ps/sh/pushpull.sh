...
export MEGASCALE_PS_PARTITION_BYTES=${MEGASCALE_PS_PARTITION_BYTES:-4096000}
...
export MEGASCALE_PS_RDMA_START_DEPTH=${MEGASCALE_PS_RDMA_START_DEPTH:-64}
...
exec bpslaunch python3 /usr/local/megascale_ps/example/pytorch/pushpull_bench.py \
    --size-mb 50 --iters 50 
